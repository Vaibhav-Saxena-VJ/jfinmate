...
<script type="application/ld+json">
{
  ...
  "itemListElement": [{
    ...
    "item": "https://jfinserv.com/properties"  
  }]
}
</script>
@section('endsection')
...
<div class="container-fluid bg-breadcrumb" style="background-image: url(../theme/frontend/img/prop-bnr.jpg);" alt="Properties in Pune">
    <div class="container py-5">
        <h1 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">Find Properties in Pune</h1>
    </div>
</div>
        ...
        <?php 
            foreach($data['allProperties'] as $v) {  
                ...
                <div class="col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="blog-item">
                        <div class="blog-img">
                            <img src="{{ $img }}" class="img-fluid rounded-top w-100" alt="Properties in Pune" style="height: 250px">
