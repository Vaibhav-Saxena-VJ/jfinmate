...
@section('canonical', "https://jfinserv.com/lease-rental-discounting")
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "What is Lease Rental Discounting (LRD)?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Lease Rental Discounting is a term loan offered against rental receipts from a leased commercial property. The future rent is used as a repayment source."
    }
  },{
    "@type": "Question",
    "name": "How does leased property financing work in Pune?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Leased property financing in Pune allows property owners to get loans against the rental income of their commercial or residential property leased to tenants."
    }
  },{
    "@type": "Question",
    "name": "Can I apply for Lease Rental Discounting on a residential property in Pune?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes, if your residential property is leased to a credible tenant with a registered agreement, you may be eligible for LRD from select lenders."
    }
  },{
    "@type": "Question",
    "name": "What documents are required for Lease Rental Discounting in Pune?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "You'll typically need the lease agreement, property documents, rent receipts, and tenant details, along with your financial documents."
    }
  },{
    "@type": "Question",
    "name": "Are there properties available for lease in Pune suitable for LRD?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes, Pune has a range of commercial and residential properties available for lease that qualify for LRD, especially in areas like Baner, Kharadi, Viman Nagar, and Hinjewadi."
    }
  }]
}
</script>
    ...
    <div class="container">
        ...
        <div class="row g-2 pb-4">
            <div class="col-lg-2 col-md-6 col-sm-12 border me-3">
                <div class="p-3">
                    <img src="{{ asset('theme') }}/frontend/img/high-value.png" alt = "Lease Rental Discounting" class="w-25 pb-3">
                    <p class="m-0 text-dark">High-value Financing</p>
                </div>
            </div>
            <div class="col-lg-2 col-md-6 col-sm-12 border me-3">
                <div class="p-3">
                    <img src="{{ asset('theme') }}/frontend/img/repayment.png" alt = "Lease Rental Discounting" class="w-25 pb-3">
                    <p class="m-0 text-dark">Comfortable Repayment Plans</p>
                </div>
            </div>
            <div class="col-lg-2 col-md-6 col-sm-12 border me-3">
                <div class="p-3">
                    <img src="{{ asset('theme') }}/frontend/img/flexi-loan.png" alt = "Lease Rental Discounting" class="w-25 pb-3">
                    <p class="m-0 text-dark">Flexi Loan Facility</p>
                </div>
            </div>
            <div class="col-lg-2 col-md-6 col-sm-12 border me-3">
                <div class="p-3">
                    <img src="{{ asset('theme') }}/frontend/img/foreclosure.png" alt = "Lease Rental Discounting" class="w-25 pb-3">
